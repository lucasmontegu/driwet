						...
						{stops.map((stop) => (
							<TouchableOpacity
								...
								style={[
									styles.stopItem,
									{
										backgroundColor: selectedStops.has(stop.id)
											? colors.primary + "10"
											: "transparent",
									},
								]}
							...
							>
								<View
									style={[
										styles.stopCheckbox,
										{
											borderColor: selectedStops.has(stop.id)
												? colors.primary
												: colors.border,
											backgroundColor: selectedStops.has(stop.id)
												? colors.primary
								...
								<View style={styles.stopInfo}>
									<View style={styles.stopHeader}>
										...
										<Text
											style={[styles.stopKm, { color: colors.mutedForeground }]}
										>
											km {stop.km}
										</Text>
									</View>
								...
								>
									...
									<View style={styles.crowdInfo}>
										<Text
											style={[
												styles.crowdLevel,
												{ color: getCrowdColor(dest.crowdLevel) },
											]}
										>
											{dest.crowdLevel === "low"
												? "Baja"
												: dest.crowdLevel === "medium"
													? "Media"
													: "Alta"}
										</Text>
										<Text
